    ...
    <div className="flex flex-col md:flex-row items-center justify-center min-h-screen bg-gray-900 text-white p-6 md:p-12 ">
      <div className="md:w-1/2 flex flex-col space-y-6 md:ml-10">
        <h1 className="text-4xl md:text-5xl font-bold">
          Dorme bem, vive melhor: <br /> Saiba a importância de uma boa noite de sono
        </h1>
        <p className="text-lg text-gray-300">
          Uma noite de sono de qualidade é fundamental para a nossa saúde e bem-estar.
          Aprenda como ter uma rotina de sono saudável e os benefícios de dormir bem.
        </p>
